...
# Access token
TOKEN = "sl.BFJ8nYAbv5FKc-YJK7Arp67aQqDz4t8M0dxBvnGOnx_u34Pb9VufNKbj3ckSmcb99PK06X14WZE3oiErZ-W4ERidCVy6nogr9qiiqmEBmIlJ2iqv8I3z5E7Pb-3FtBGC1I-SR80m-k0"

LOCALFILE = f"test.txt"

BACKUPPATH = (
    f"/{current_date}/runtime.log"  # Keep the forward slash before destination filename
)
